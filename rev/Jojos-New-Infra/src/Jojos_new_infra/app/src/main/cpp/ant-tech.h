...
Java_com_example_jojos_1new_1infra_14_14_checkStuff_cS(
    ...
    if (debugModeSet) {
        ...
        SIGNATURE = encryptDecryptUsername("1GrwFP)-65dAVPM0hi4iopRp^}9f", "]?=G+#~g_yP'0&>TC=V(]=9%51x[");
    }
...
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_example_jojos_1new_1infra_checkStuff_14_14_checkStuff_ctp(JNIEnv *env, jobject thiz) {
